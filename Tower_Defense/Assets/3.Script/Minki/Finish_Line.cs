        ...
        if (other.gameObject.layer == 6 && isServer)
        {
            ...
            switch (col_num)
            {
                ...
                case 1:
                    if (player_num == 2)
                    {
                        mon.transform.position = point.SpawnPoint[2].position;
                        monAI.target = point.FinPoint[2];
                    }
                    else
                    {
                        mon.transform.position = point.SpawnPoint[1].position;
                ...
                case 2:
                    if (player_num == 3)
                    {
                        mon.transform.position = point.SpawnPoint[3].position;
                ...
                case 3:
                    if (player_num == 4)
                    {
                        mon.transform.position = point.SpawnPoint[0].position;
